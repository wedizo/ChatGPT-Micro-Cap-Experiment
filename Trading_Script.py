...
def log_manual_buy(buy_price, shares, ticker, cash):
    ...
    if buy_price * shares > cash:
        print(f"error, you have {cash} but are trying to spend {buy_price * shares}. Are you sure you can do this?")
    pnl = 0.0
